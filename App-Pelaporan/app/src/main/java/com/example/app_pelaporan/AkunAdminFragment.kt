...
import com.example.app_pelaporan.databinding.FragmentAkunAdminBinding
...
class AkunAdminFragment : Fragment() {
    lateinit var binding: FragmentAkunAdminBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAkunAdminBinding.inflate(layoutInflater)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editFotoprofil.setOnClickListener {
            changeProfileImage()
        }
        binding.cardLogout.setOnClickListener {
            logout()
        }
        binding.cardListadmin.setOnClickListener{
